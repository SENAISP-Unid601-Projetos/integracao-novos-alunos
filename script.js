...
function carregarPlanta(planta) {
  ...
  if (planta === 'Piso Superior') {
    ...
    imagem = '/integracao-novos-alunos/imagens/area1superior.png';
  } else if (planta === 'Piso Inferior') {
    bounds = [
      [-22.002, -47.899],
      [-22.0, -47.897],
    ];
    imagem = '/integracao-novos-alunos/imagens/area1inferior.png';
  } else if (planta === 'Bloco Geral') {
    bounds = [
      [-22.003, -47.896],
      [-22.001, -47.894],
    ];
    imagem = '/integracao-novos-alunos/imagens/blocoB.png';
  }
